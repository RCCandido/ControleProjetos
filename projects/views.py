...
@login_required(login_url='/index')
def home(request):
  return render(request, "projects/home.html", { 'qtdUsuarios': 10, 'qtdServicos': 1 })
...
def cadastrar_usuario(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(request, 'projects/cadastro_usuario.html', {'form': form_usuario, 'message': message, 'type': "danger"})
    else:
        form_usuario = NewUsuarioForm()
        return render(request, 'projects/cadastro_usuario.html', {'form': form_usuario, 'message': message, 'type': "success" })
