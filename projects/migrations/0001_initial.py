# Generated by Django 5.0.7 on 2024-08-20 01:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Projetos',
            fields=[
                ('codigo', models.CharField(max_length=8, primary_key=True, serialize=False, unique=True, verbose_name='Código')),
                ...
                ('qtd_horas_apontadas', models.DecimalField(decimal_places=2, max_digits=4)),
                ('qtd_horas_projeto', models.DecimalField(decimal_places=2, max_digits=4)),
